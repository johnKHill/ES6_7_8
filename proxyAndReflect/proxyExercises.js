...
//                     }    
//              default:
//                 throw new TypeError(`Invalid datatype...Only arrays, string and null are valid`)
//             }
//         }else{
//             target[propName] = newValue
//         }
...
// Clearing some space for the next build
console.log("\n");
...
const importantHandler = {
    apply: (target, thisArg, argsList)=>{
        ...
        // Use appendFile inside of the proxy. Check the docs, but it will look like this:
